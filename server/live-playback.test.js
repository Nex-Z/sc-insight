...
function fixture(){
 ...
 const controller=manageLivePlayback(video,{getHls:()=>({startLoad(){loads++;},recoverMediaError(){repairs++;},liveSyncPosition:20}),onStatus:s=>status.push(s),now:()=>time,interval:fn=>{tick=fn;return 1;},cancelInterval:()=>{tick=()=>{};}});
